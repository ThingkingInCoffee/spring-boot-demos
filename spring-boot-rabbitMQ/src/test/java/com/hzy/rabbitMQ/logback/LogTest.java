package com.hzy.rabbitMQ.logback;
...
public class LogTest {
    ...
    @Test
    public void test02() {
        Logger fooLogger = (ch.qos.logback.classic.Logger) LoggerFactory.getLogger("com.hzy.rabbitMQ");
    ...
    @Test
    public void test003() {
        Logger LOGGER = (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(LogTest.class);
